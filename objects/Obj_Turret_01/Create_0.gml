...
TurretDamage = 5 + 1 * global.Upgrades.Turret_01.Damage; // Turret's bullet Damage
Cooldown = 60 - 5 * global.Upgrades.Turret_01.Speed; // Cooldown to fire
AtackRange = 50 + 25 * global.Upgrades.Turret_01.Range;	// Radius at which the turret can shoot
